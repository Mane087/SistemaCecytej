...
import { getPrestamos } from '../APi/Libros';
import ModalPrestamos from '../Components/ModalPrestamos';
...
const Prestamos = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            sortable: true,
            format: row => new Date(row.fecha_prestamo).toLocaleDateString("es-MX", {
    ...
    return (
        ...
        <div className='flex items-center py-5 gap-5'>
            <h1 className='font-bold text-2xl mr-5'>Prestamos</h1>
